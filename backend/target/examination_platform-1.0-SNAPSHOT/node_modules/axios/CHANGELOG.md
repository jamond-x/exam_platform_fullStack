...
Internal and Tests:
- Adding axios-test-entity to ecosystem ([#3786](https://github.com/axios/axios/pull/3786))
...
- Fixed default transitional config for custom Axios entity; ([#4052](https://github.com/axios/axios/pull/4052))
...
- Fix Keep defaults local to entity ([#385](https://github.com/axios/axios/issues/385))
...
- Fix Default method for an entity always overwritten by get
...
- Fixing configuration when using an entity - method can now be set ([#1342](https://github.com/axios/axios/pull/1342))
...
- Fixing custom entity defaults ([#341](https://github.com/axios/axios/issues/341))
...
- Adding request entity to response ([#200](https://github.com/axios/axios/pull/200))
